...
if __name__ == "__main__":
    ...
    make(save_path_root='C:/Users/Choi Byeoli/STAR-Private/datasmpl/',num_beta=10,
    template=smplData.template,
    shapeblendshape=smplData.shapeblendshape,
    jointregressor_matrix=smplData.jointregressor_matrix)
    merge(save_path_root='C:/Users/Choi Byeoli/STAR-Private/datasmpl/')

    save_reference(save_path_root='C:/Users/Choi Byeoli/STAR-Private/datasmpl/',num_beta=10,
    template=smplData.template, 
    shapeblendshape=smplData.shapeblendshape,
    jointregressor_matrix=smplData.jointregressor_matrix)
